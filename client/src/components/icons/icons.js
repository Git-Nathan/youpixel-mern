  ...
  >
    ...
    <defs>
      <clipPath id="clip0_74_173">
        <rect width="9" height="12" fill="white" transform="translate(11 4)" />
      </clipPath>
    </defs>
  </svg>
)
...
export const TopSubcribedIcon = ({
  ...
  >
    ...
    <path
      d="M9.71094 7.16541C9.36406 6.95213 8.92813 6.9451 8.57422 7.14432C8.22031 7.34354 8 7.71854 8 8.12635V16.3764C8 16.7842 8.22031 17.1592 8.57422 17.3584C8.92813 17.5576 9.36406 17.5482 9.71094 17.3373L16.4609 13.2123C16.7961 13.0084 17 12.6451 17 12.2514C17 11.8576 16.7961 11.4967 16.4609 11.2904L9.71094 7.16541Z"
      fill="#15141B"
    />
  </svg>
)

export const MyVideosIcon = ({
  width = '24px',
  height = '24px',
  className,
}) => (
  ...
  >
    <path
      d="M4 0.679688C1.79375 0.679688 0 2.47344 0 4.67969V28.6797C0 30.8859 1.79375 32.6797 4 32.6797H20C22.2062 32.6797 24 30.8859 24 28.6797V10.6797H16C14.8938 10.6797 14 9.78594 14 8.67969V0.679688H4ZM16 0.679688V8.67969H24L16 0.679688ZM4 18.6797C4 17.5734 4.89375 16.6797 6 16.6797H12C13.1062 16.6797 14 17.5734 14 18.6797V24.6797C14 25.7859 13.1062 26.6797 12 26.6797H6C4.89375 26.6797 4 25.7859 4 24.6797V18.6797ZM18.8062 25.5484L16 23.6797V19.6797L18.8062 17.8109C18.9312 17.7297 19.0813 17.6797 19.2313 17.6797C19.6562 17.6797 20 18.0234 20 18.4484V24.9109C20 25.3359 19.6562 25.6797 19.2313 25.6797C19.0813 25.6797 18.9312 25.6359 18.8062 25.5484Z"
      fill="white"
    />
  </svg>
)

export const TopLikesIcon = ({
  width = '24px',
  height = '24px',
  className,
}) => (
  ...
  >
    <path
      d="M1.98333 11.6515L9.5125 18.6807C9.825 18.9723 10.2375 19.1348 10.6667 19.1348C11.0958 19.1348 11.5083 18.9723 11.8208 18.6807L11.9292 18.5807C11.1333 17.4098 10.6667 15.9932 10.6667 14.4682C10.6667 10.4182 13.95 7.13483 18 7.13483C19.1792 7.13483 20.2917 7.41399 21.2792 7.90566C21.3167 7.63483 21.3333 7.36399 21.3333 7.08899V6.84733C21.3333 3.93483 19.2292 1.45149 16.3583 0.972326C14.4583 0.655659 12.525 1.27649 11.1667 2.63483L10.6667 3.13483L10.1667 2.63483C8.80833 1.27649 6.875 0.655659 4.975 0.972326C2.10417 1.45149 0 3.93483 0 6.84733V7.08899C0 8.81816 0.716667 10.4723 1.98333 11.6515ZM24 14.4682C24 11.1557 21.3125 8.46816 18 8.46816C14.6875 8.46816 12 11.1557 12 14.4682C12 17.7807 14.6875 20.4682 18 20.4682C21.3125 20.4682 24 17.7807 24 14.4682ZM20.8042 12.664C21.0625 12.9223 21.0625 13.3473 20.8042 13.6057L17.8042 16.6057C17.5458 16.864 17.1208 16.864 16.8625 16.6057L15.1958 14.939C14.9375 14.6807 14.9375 14.2557 15.1958 13.9973C15.4542 13.739 15.8792 13.739 16.1375 13.9973L17.3333 15.1932L19.8625 12.664C20.1208 12.4057 20.5458 12.4057 20.8042 12.664Z"
      fill="white"
    />
  </svg>
)

export const WatchedIcon = ({ width = '24px', height = '24px', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
  ...
  >
    <path
      d="M3.51562 4.19531L1.92188 2.60156C1.21406 1.89375 0 2.39531 0 3.39375V8.55469C0 9.17813 0.501562 9.67969 1.125 9.67969H6.28594C7.28906 9.67969 7.79063 8.46563 7.08281 7.75781L5.63906 6.31406C7.26563 4.6875 9.51562 3.67969 12 3.67969C16.9688 3.67969 21 7.71094 21 12.6797C21 17.6484 16.9688 21.6797 12 21.6797C10.0875 21.6797 8.31563 21.0844 6.85781 20.0672C6.17813 19.5938 5.24531 19.7578 4.76719 20.4375C4.28906 21.1172 4.45781 22.05 5.1375 22.5281C7.0875 23.8828 9.45469 24.6797 12 24.6797C18.6281 24.6797 24 19.3078 24 12.6797C24 6.05156 18.6281 0.679688 12 0.679688C8.68594 0.679688 5.68594 2.025 3.51562 4.19531ZM12 6.67969C11.3766 6.67969 10.875 7.18125 10.875 7.80469V12.6797C10.875 12.9797 10.9922 13.2656 11.2031 13.4766L14.5781 16.8516C15.0187 17.2922 15.7312 17.2922 16.1672 16.8516C16.6031 16.4109 16.6078 15.6984 16.1672 15.2625L13.1203 12.2156V7.80469C13.1203 7.18125 12.6187 6.67969 11.9953 6.67969H12Z"
      fill="white"
    />
  </svg>
)

export const WatchedIconActive = ({
  width = '24px',
  height = '24px',
  className,
}) => (
...
export const TopViewsIcon = ({
  ...
  >
    <path
      d="M8.5 1.25098C9 -0.248991 9.58214 -0.140064 10 0.251007C11.5 2.25096 12.75 11.4563 14.0464 13.0742C14.6357 12.3028 15.4393 7.43312 16.1625 6.7474C16.5857 6.35098 17.2393 6.35098 17.6625 6.75276C19.5161 8.52062 21.0857 10.8563 22.1893 13.0742C23.2768 15.2599 24 17.4938 24 19.0688C24 25.9045 18.6536 31.6795 12 31.6795C5.27143 31.6795 0.000100139 26.5867 0 19.751C-3.66233e-05 17.251 2.52143 13.6653 4 11.1795C5.49464 8.65633 7 5.17952 8.5 1.25098ZM12.0911 26.5367C13.4464 26.5367 14.6464 26.1617 15.7768 25.4117C18.0321 23.8367 18.6375 20.6867 17.2821 18.2117C17.1321 17.9117 16.9821 17.6117 16.7571 17.3117L14.0464 20.4617C14.0464 20.4617 9.68571 14.9117 9.38036 14.5367C7.13036 17.3117 6 18.8867 6 20.6867C6 24.3617 8.71071 26.5367 12.0911 26.5367Z"
      fill="white"
    />
  </svg>
)

export const TopViewsIconActive = ({
  width = '24px',
  height = '24px',
  className,
}) => (
...
export const ShareIcon = ({ width = '24px', height = '24px', className }) => (
  ...
  >
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M24 7.4086L17.1767 14.8172V11.1264C12.8621 10.1655 9.45366 11.2247 6.86499 14.7523C7.3144 7.49719 11.925 3.99601 17.1765 3.76424L17.1767 0L24 7.4086Z"
      fill="white"
    />
    <path
...
export const DeleteIcon = ({ width = '24px', height = '24px', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const EditIcon = ({ width = '24px', height = '24px', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
